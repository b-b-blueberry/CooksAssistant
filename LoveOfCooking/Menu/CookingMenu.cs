...
namespace LoveOfCooking.Menu
{
	public class CookingMenu : ItemGrabMenu
    {
		...
		internal static readonly Rectangle CookingSkillIconArea = new(0, 100, 10, 10);
        ...
        internal static readonly Rectangle FilterContainerSource = new(120, 0, 13, 18);
        ...
        internal static readonly Rectangle ReadyIconSource = new(12, 122, 12, 12);
        internal static readonly Rectangle FavouriteIconSource = new(24, 122, 12, 12);
		internal static readonly Rectangle StarIconSource = new(36, 122, 12, 12);
        internal static readonly Rectangle BuffIconSource = new(48, 122, 12, 12);
		...
		internal static readonly Rectangle InventoryTabButtonSource = new(104, 0, 16, 21);
        ...
        internal static readonly Rectangle UpperRightCloseIconSource = new(0, 89, 11, 11);
		internal static readonly Rectangle UpperRightHelpIconSource = new(11, 89, 11, 11);
		...
		public bool TryCookRecipe(CraftingRecipe recipe, int quantity)
        {
			...
			else
			{
                ...
                this.PopMenuStack(playSound: false, tryToQuit: false);
            }
