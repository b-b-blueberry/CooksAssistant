...
namespace LoveOfCooking.Menu
{
	public class CookingMenu : ItemGrabMenu
    {
        ...
        internal static readonly Rectangle InventoryFridgeIconSource = new(244, 118, 12, 14);
        internal static readonly Rectangle InventoryMinifridgeIconSource = new(244, 134, 12, 14);
        internal static readonly Rectangle InventoryChestIconSource = new(244, 148, 12, 14);
